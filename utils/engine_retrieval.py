...
from model.retrieval.loss import get_retrieval_loss, batch_cpt_discriminate, att_consistence, att_area_loss
...
def train(args, model, device, loader, optimizer, epoch):
    ...
    if not args.pre_train:
        show_items = [retri_losses, q_losses, pred_acces, batch_dis_losses, consistence_losses, att_losses]
    else:
