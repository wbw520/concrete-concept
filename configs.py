...
parser.add_argument('--pre_train', default=True, type=bool, help='whether pre-train the model')
...
parser.add_argument('--att_bias', type=float, default=1, help='used to prevent overflow, default as 0.1')
parser.add_argument('--quantity_bias', type=float, default=0.1, help='force each concept to be binary')
parser.add_argument('--distinctiveness_bias', type=float, default=0.05, help='refer to paper')
parser.add_argument('--consistence_bias', type=float, default=0.01, help='refer to paper')
# ========================= Learning Configs ==========================
